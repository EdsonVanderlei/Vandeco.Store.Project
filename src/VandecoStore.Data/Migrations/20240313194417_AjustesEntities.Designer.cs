...
namespace VandecoStore.Data.Migrations
{
    ...
    [Migration("20240313194417_AjustesEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VandecoStore.Domain.Entities.OrderStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("StatusProcessEnum")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VandecoStore.Domain.Tests.Tests.Entities.ReceiptPurchase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VandecoStore.Domain.Entities.User", b =>
                {
                    ...
                    b.OwnsOne("VandecoStore.Domain.ObjectValues.Phone", "Fax", b1 =>
                        {
                            b1.Property<Guid>("UserId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("VandecoStore.Domain.ObjectValues.Phone", "Phone", b1 =>
                        {
                            b1.Property<Guid>("UserId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("VandecoStore.Domain.ObjectValues.Mail", "Mail", b1 =>
                        {
                            b1.Property<Guid>("UserId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VandecoStore.Domain.Tests.Tests.Entities.ReceiptPurchase", b =>
                {
                    ...
                    b.OwnsOne("VandecoStore.Domain.Entities.Document", "IssuerDocument", b1 =>
                        {
                            b1.Property<Guid>("ReceiptPurchaseId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("ReceiptPurchaseId");

                            b1.ToTable("ReceiptPurchase");

                            b1.WithOwner()
                                .HasForeignKey("ReceiptPurchaseId");
                        });

                    b.Navigation("IssuerDocument")
                        .IsRequired();
