...
namespace VandecoStore.Domain.Tests
{
    public class AddressTests
    {
        ...
        public void Address_WithValidParameters_CreateInstance()
        {
            ...
            //Act 
            var address = new Address(street, zipCode, neighboardHood, city, country, state, number, complement);
        ...
        {
            // Arrange & Act & Assert
            Assert.Throws<System.InvalidOperationException>(() => new Address(street, zipCode, neighborhood, city, country, state, number, complement));
        }
    }
}